...
- `elements`: <span className="code">Array\<null | [Expression](#expression) | [SpreadElement](#spreadelement)\></span> (default: `[]`)
...
- `elements`: <span className="code">Array\<null | [PatternLike](#patternlike)\></span> (required)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`, excluded from builder function)
- `optional`: boolean (default: `null`, excluded from builder function)
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
...
- `elementType`: <span className="code">[FlowType](#flowtype)</span> (required)
...
- `params`: <span className="code">Array\<<span className="code">[FunctionParameter](#functionparameter)</span>\></span> (required)
- `body`: <span className="code">[BlockStatement](#blockstatement) | [Expression](#expression)</span> (required)
- `async`: boolean (default: `false`)
- `expression`: boolean (required)
- `generator`: boolean (default: `false`, excluded from builder function)
- `predicate`: <span className="code">[DeclaredPredicate](#declaredpredicate) | [InferredPredicate](#inferredpredicate)</span> (default: `null`, excluded from builder function)
- `returnType`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
- `typeParameters`: <span className="code">[TypeParameterDeclaration](#typeparameterdeclaration) | [TSTypeParameterDeclaration](#tstypeparameterdeclaration) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
...
- `left`: <span className="code">[LVal](#lval) | [OptionalMemberExpression](#optionalmemberexpression)</span> (required)
- `right`: <span className="code">[Expression](#expression)</span> (required)
...
- `left`: <span className="code">[Identifier](#identifier) | [ObjectPattern](#objectpattern) | [ArrayPattern](#arraypattern) | [MemberExpression](#memberexpression) | [TSAsExpression](#tsasexpression) | [TSSatisfiesExpression](#tssatisfiesexpression) | [TSTypeAssertion](#tstypeassertion) | [TSNonNullExpression](#tsnonnullexpression)</span> (required)
- `right`: <span className="code">[Expression](#expression)</span> (required)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`, excluded from builder function)
- `optional`: boolean (default: `null`, excluded from builder function)
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
...
- `argument`: <span className="code">[Expression](#expression)</span> (required)
...
- `left`: <span className="code">[Expression](#expression) | [PrivateName](#privatename)</span> (required)
- `right`: <span className="code">[Expression](#expression)</span> (required)
...
- `object`: <span className="code">[Expression](#expression)</span> (required)
- `callee`: <span className="code">[Expression](#expression)</span> (required)
...
- `body`: <span className="code">Array\<<span className="code">[Statement](#statement)</span>\></span> (required)
- `directives`: <span className="code">Array\<<span className="code">[Directive](#directive)</span>\></span> (default: `[]`)
...
- `label`: <span className="code">[Identifier](#identifier)</span> (default: `null`)
...
- `callee`: <span className="code">[Expression](#expression) | [Super](#super) | [V8IntrinsicIdentifier](#v8intrinsicidentifier)</span> (required)
- `arguments`: <span className="code">Array\<<span className="code">[Expression](#expression) | [SpreadElement](#spreadelement) | [ArgumentPlaceholder](#argumentplaceholder)</span>\></span> (required)
- `optional`: boolean (default: `null`, excluded from builder function)
- `typeArguments`: <span className="code">[TypeParameterInstantiation](#typeparameterinstantiation)</span> (default: `null`, excluded from builder function)
- `typeParameters`: <span className="code">[TSTypeParameterInstantiation](#tstypeparameterinstantiation)</span> (default: `null`, excluded from builder function)
...
- `param`: <span className="code">[Identifier](#identifier) | [ArrayPattern](#arraypattern) | [ObjectPattern](#objectpattern)</span> (default: `null`)
- `body`: <span className="code">[BlockStatement](#blockstatement)</span> (required)
...
- `key`: <span className="code">[Identifier](#identifier) | [StringLiteral](#stringliteral) | [NumericLiteral](#numericliteral) | [BigIntLiteral](#bigintliteral) | [Expression](#expression) | [PrivateName](#privatename)</span> (required)
- `value`: <span className="code">[Expression](#expression)</span> (default: `null`)
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`)
...
- `variance`: <span className="code">[Variance](#variance)</span> (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (default: `null`)
- `superClass`: <span className="code">[Expression](#expression)</span> (default: `null`)
- `body`: <span className="code">[ClassBody](#classbody)</span> (required)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`)
- `abstract`: boolean (default: `null`, excluded from builder function)
- `declare`: boolean (default: `null`, excluded from builder function)
- `implements`: <span className="code">Array\<<span className="code">[TSExpressionWithTypeArguments](#tsexpressionwithtypearguments) | [ClassImplements](#classimplements)</span>\></span> (default: `null`, excluded from builder function)
- `mixins`: <span className="code">[InterfaceExtends](#interfaceextends)</span> (default: `null`, excluded from builder function)
- `superTypeParameters`: <span className="code">[TypeParameterInstantiation](#typeparameterinstantiation) | [TSTypeParameterInstantiation](#tstypeparameterinstantiation)</span> (default: `null`, excluded from builder function)
- `typeParameters`: <span className="code">[TypeParameterDeclaration](#typeparameterdeclaration) | [TSTypeParameterDeclaration](#tstypeparameterdeclaration) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `typeParameters`: <span className="code">[TypeParameterInstantiation](#typeparameterinstantiation)</span> (default: `null`)
...
- `params`: <span className="code">Array\<<span className="code">[FunctionParameter](#functionparameter) | [TSParameterProperty](#tsparameterproperty)</span>\></span> (required)
- `body`: <span className="code">[BlockStatement](#blockstatement)</span> (required)
- `computed`: boolean (default: `false`)
- `static`: boolean (default: `false`)
...
- `key`: <span className="code">[PrivateName](#privatename)</span> (required)
- `params`: <span className="code">Array\<<span className="code">[FunctionParameter](#functionparameter) | [TSParameterProperty](#tsparameterproperty)</span>\></span> (required)
- `body`: <span className="code">[BlockStatement](#blockstatement)</span> (required)
- `static`: boolean (default: `false`)
- `abstract`: boolean (default: `null`, excluded from builder function)
...
- `key`: <span className="code">[Identifier](#identifier) | [StringLiteral](#stringliteral) | [NumericLiteral](#numericliteral) | [BigIntLiteral](#bigintliteral) | [Expression](#expression)</span> (required)
- `value`: <span className="code">[Expression](#expression)</span> (default: `null`)
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`)
- `computed`: boolean (default: `false`)
...
- `test`: <span className="code">[Expression](#expression)</span> (required)
- `consequent`: <span className="code">[Expression](#expression)</span> (required)
- `alternate`: <span className="code">[Expression](#expression)</span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `typeParameters`: <span className="code">[TypeParameterDeclaration](#typeparameterdeclaration)</span> (default: `null`)
- `extends`: <span className="code">Array\<<span className="code">[InterfaceExtends](#interfaceextends)</span>\></span> (default: `null`)
- `body`: <span className="code">[ObjectTypeAnnotation](#objecttypeannotation)</span> (required)
- `implements`: <span className="code">Array\<<span className="code">[ClassImplements](#classimplements)</span>\></span> (default: `null`, excluded from builder function)
- `mixins`: <span className="code">Array\<<span className="code">[InterfaceExtends](#interfaceextends)</span>\></span> (default: `null`, excluded from builder function)
...
<Code language="javascript">t.declareExportAllDeclaration(source, attributes);</Code>
...
- `source`: <span className="code">[StringLiteral](#stringliteral)</span> (required)
- `attributes`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`)
- `assertions`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`, excluded from builder function)
...
<Code language="javascript">t.declareExportDeclaration(declaration, specifiers, source, attributes);</Code>
...
- `declaration`: <span className="code">[Flow](#flow)</span> (default: `null`)
- `specifiers`: <span className="code">Array\<<span className="code">[ExportSpecifier](#exportspecifier) | [ExportNamespaceSpecifier](#exportnamespacespecifier)</span>\></span> (default: `null`)
- `source`: <span className="code">[StringLiteral](#stringliteral)</span> (default: `null`)
- `attributes`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`)
- `assertions`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `predicate`: <span className="code">[DeclaredPredicate](#declaredpredicate)</span> (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[Identifier](#identifier) | [StringLiteral](#stringliteral)</span> (required)
- `body`: <span className="code">[BlockStatement](#blockstatement)</span> (required)
...
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation)</span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `typeParameters`: <span className="code">[TypeParameterDeclaration](#typeparameterdeclaration)</span> (default: `null`)
- `supertype`: <span className="code">[FlowType](#flowtype)</span> (default: `null`)
- `impltype`: <span className="code">[FlowType](#flowtype)</span> (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `typeParameters`: <span className="code">[TypeParameterDeclaration](#typeparameterdeclaration)</span> (default: `null`)
- `right`: <span className="code">[FlowType](#flowtype)</span> (required)
...
- `value`: <span className="code">[Flow](#flow)</span> (required)
...
- `expression`: <span className="code">[Expression](#expression)</span> (required)
...
- `value`: <span className="code">[DirectiveLiteral](#directiveliteral)</span> (required)
...
- `test`: <span className="code">[Expression](#expression)</span> (required)
- `body`: <span className="code">[Statement](#statement)</span> (required)
...
- `members`: <span className="code">Array\<<span className="code">[EnumBooleanMember](#enumbooleanmember)</span>\></span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `init`: <span className="code">[BooleanLiteral](#booleanliteral)</span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `body`: <span className="code">[EnumBooleanBody](#enumbooleanbody) | [EnumNumberBody](#enumnumberbody) | [EnumStringBody](#enumstringbody) | [EnumSymbolBody](#enumsymbolbody)</span> (required)
...
- `members`: <span className="code">Array\<<span className="code">[EnumNumberMember](#enumnumbermember)</span>\></span> (required)
- `explicitType`: boolean (required)
- `hasUnknownMembers`: boolean (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `init`: <span className="code">[NumericLiteral](#numericliteral)</span> (required)
...
- `members`: <span className="code">Array\<<span className="code">[EnumStringMember](#enumstringmember) | [EnumDefaultedMember](#enumdefaultedmember)</span>\></span> (required)
- `explicitType`: boolean (required)
- `hasUnknownMembers`: boolean (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `init`: <span className="code">[StringLiteral](#stringliteral)</span> (required)
...
- `members`: <span className="code">Array\<<span className="code">[EnumDefaultedMember](#enumdefaultedmember)</span>\></span> (required)
- `hasUnknownMembers`: boolean (required)
...
<Code language="javascript">t.exportAllDeclaration(source, attributes);</Code>
...
- `declaration`: <span className="code">[TSDeclareFunction](#tsdeclarefunction) | [FunctionDeclaration](#functiondeclaration) | [ClassDeclaration](#classdeclaration) | [Expression](#expression)</span> (required)
...
- `exported`: <span className="code">[Identifier](#identifier)</span> (required)
...
<Code language="javascript">t.exportNamedDeclaration(declaration, specifiers, source, attributes);</Code>
...
- `declaration`: <span className="code">[Declaration](#declaration)</span> (default: `null`)
- `specifiers`: <span className="code">Array\<<span className="code">[ExportSpecifier](#exportspecifier) | [ExportDefaultSpecifier](#exportdefaultspecifier) | [ExportNamespaceSpecifier](#exportnamespacespecifier)</span>\></span> (default: `[]`)
- `source`: <span className="code">[StringLiteral](#stringliteral)</span> (default: `null`)
- `attributes`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`)
- `assertions`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`, excluded from builder function)
- `exportKind`: `"type" | "value"` (default: `null`, excluded from builder function)
...
- `local`: <span className="code">[Identifier](#identifier)</span> (required)
- `exported`: <span className="code">[Identifier](#identifier) | [StringLiteral](#stringliteral)</span> (required)
- `exportKind`: `"type" | "value"` (default: `null`, excluded from builder function)
...
AST Node `File` shape:
- `program`: <span className="code">[Program](#program)</span> (required)
- `comments`: <span className="code">Array\<<span className="code">[CommentBlock](#commentblock) | [CommentLine](#commentline)</span>\></span> (default: `null`)
- `tokens`: <span className="code">Array\<any\></span> (default: `null`)
...
- `left`: <span className="code">[VariableDeclaration](#variabledeclaration) | [LVal](#lval)</span> (required)
- `right`: <span className="code">[Expression](#expression)</span> (required)
- `body`: <span className="code">[Statement](#statement)</span> (required)
...
- `init`: <span className="code">[VariableDeclaration](#variabledeclaration) | [Expression](#expression)</span> (default: `null`)
- `test`: <span className="code">[Expression](#expression)</span> (default: `null`)
- `update`: <span className="code">[Expression](#expression)</span> (default: `null`)
- `body`: <span className="code">[Statement](#statement)</span> (required)
...
- `typeParameters`: <span className="code">[TypeParameterDeclaration](#typeparameterdeclaration)</span> (default: `null`)
- `params`: <span className="code">Array\<<span className="code">[FunctionTypeParam](#functiontypeparam)</span>\></span> (required)
- `rest`: <span className="code">[FunctionTypeParam](#functiontypeparam)</span> (default: `null`)
- `returnType`: <span className="code">[FlowType](#flowtype)</span> (required)
- `this`: <span className="code">[FunctionTypeParam](#functiontypeparam)</span> (default: `null`, excluded from builder function)
...
- `name`: <span className="code">[Identifier](#identifier)</span> (default: `null`)
- `typeAnnotation`: <span className="code">[FlowType](#flowtype)</span> (required)
- `optional`: boolean (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[Identifier](#identifier) | [QualifiedTypeIdentifier](#qualifiedtypeidentifier)</span> (required)
- `typeParameters`: <span className="code">[TypeParameterInstantiation](#typeparameterinstantiation)</span> (default: `null`)
...
- `test`: <span className="code">[Expression](#expression)</span> (required)
- `consequent`: <span className="code">[Statement](#statement)</span> (required)
- `alternate`: <span className="code">[Statement](#statement)</span> (default: `null`)
...
- `key`: <span className="code">[Identifier](#identifier) | [StringLiteral](#stringliteral)</span> (required)
- `value`: <span className="code">[StringLiteral](#stringliteral)</span> (required)
...
<Code language="javascript">t.importDeclaration(specifiers, source, attributes);</Code>
*ImportDeclaration*
...
- `specifiers`: <span className="code">Array\<<span className="code">[ImportSpecifier](#importspecifier) | [ImportDefaultSpecifier](#importdefaultspecifier) | [ImportNamespaceSpecifier](#importnamespacespecifier)</span>\></span> (required)
- `source`: <span className="code">[StringLiteral](#stringliteral)</span> (required)
- `attributes`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`)
- `assertions`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`, excluded from builder function)
...
- `source`: <span className="code">[Expression](#expression)</span> (required)
- `options`: <span className="code">[Expression](#expression)</span> (default: `null`)
- `phase`: `"source" | "defer"` (default: `null`, excluded from builder function)
...
- `local`: <span className="code">[Identifier](#identifier)</span> (required)
- `imported`: <span className="code">[Identifier](#identifier) | [StringLiteral](#stringliteral)</span> (required)
- `importKind`: `"type" | "typeof" | "value"` (default: `null`, excluded from builder function)
...
- `objectType`: <span className="code">[FlowType](#flowtype)</span> (required)
- `indexType`: <span className="code">[FlowType](#flowtype)</span> (required)
...
- `types`: <span className="code">Array\<<span className="code">[FlowType](#flowtype)</span>\></span> (required)
...
- `name`: <span className="code">[JSXIdentifier](#jsxidentifier) | [JSXNamespacedName](#jsxnamespacedname)</span> (required)
- `value`: <span className="code">[JSXElement](#jsxelement) | [JSXFragment](#jsxfragment) | [StringLiteral](#stringliteral) | [JSXExpressionContainer](#jsxexpressioncontainer)</span> (default: `null`)
...
- `name`: <span className="code">[JSXIdentifier](#jsxidentifier) | [JSXMemberExpression](#jsxmemberexpression) | [JSXNamespacedName](#jsxnamespacedname)</span> (required)
...
- `openingElement`: <span className="code">[JSXOpeningElement](#jsxopeningelement)</span> (required)
- `closingElement`: <span className="code">[JSXClosingElement](#jsxclosingelement)</span> (default: `null`)
- `children`: <span className="code">Array\<<span className="code">[JSXText](#jsxtext) | [JSXExpressionContainer](#jsxexpressioncontainer) | [JSXSpreadChild](#jsxspreadchild) | [JSXElement](#jsxelement) | [JSXFragment](#jsxfragment)</span>\></span> (required)
...
- `expression`: <span className="code">[Expression](#expression) | [JSXEmptyExpression](#jsxemptyexpression)</span> (required)
...
- `openingFragment`: <span className="code">[JSXOpeningFragment](#jsxopeningfragment)</span> (required)
- `closingFragment`: <span className="code">[JSXClosingFragment](#jsxclosingfragment)</span> (required)
- `children`: <span className="code">Array\<<span className="code">[JSXText](#jsxtext) | [JSXExpressionContainer](#jsxexpressioncontainer) | [JSXSpreadChild](#jsxspreadchild) | [JSXElement](#jsxelement) | [JSXFragment](#jsxfragment)</span>\></span> (required)
...
- `object`: <span className="code">[JSXMemberExpression](#jsxmemberexpression) | [JSXIdentifier](#jsxidentifier)</span> (required)
- `property`: <span className="code">[JSXIdentifier](#jsxidentifier)</span> (required)
...
- `namespace`: <span className="code">[JSXIdentifier](#jsxidentifier)</span> (required)
- `name`: <span className="code">[JSXIdentifier](#jsxidentifier)</span> (required)
...
- `name`: <span className="code">[JSXIdentifier](#jsxidentifier) | [JSXMemberExpression](#jsxmemberexpression) | [JSXNamespacedName](#jsxnamespacedname)</span> (required)
- `attributes`: <span className="code">Array\<<span className="code">[JSXAttribute](#jsxattribute) | [JSXSpreadAttribute](#jsxspreadattribute)</span>\></span> (required)
...
- `label`: <span className="code">[Identifier](#identifier)</span> (required)
- `body`: <span className="code">[Statement](#statement)</span> (required)
...
- `operator`: `"||" | "&&" | "??"` (required)
- `left`: <span className="code">[Expression](#expression)</span> (required)
- `right`: <span className="code">[Expression](#expression)</span> (required)
...
- `object`: <span className="code">[Expression](#expression) | [Super](#super)</span> (required)
...
- `meta`: <span className="code">[Identifier](#identifier)</span> (required)
- `property`: <span className="code">[Identifier](#identifier)</span> (required)
...
- `body`: <span className="code">[Program](#program)</span> (required)
...
- `properties`: <span className="code">Array\<<span className="code">[ObjectMethod](#objectmethod) | [ObjectProperty](#objectproperty) | [SpreadElement](#spreadelement)</span>\></span> (required)
...
- `properties`: <span className="code">Array\<<span className="code">[RestElement](#restelement) | [ObjectProperty](#objectproperty)</span>\></span> (required)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`, excluded from builder function)
- `optional`: boolean (default: `null`, excluded from builder function)
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
...
- `key`: if computed then `Expression` else `Identifier | Literal` (required)
- `value`: <span className="code">[Expression](#expression) | [PatternLike](#patternlike)</span> (required)
- `computed`: boolean (default: `false`)
...
- `properties`: <span className="code">Array\<<span className="code">[ObjectTypeProperty](#objecttypeproperty) | [ObjectTypeSpreadProperty](#objecttypespreadproperty)</span>\></span> (required)
- `indexers`: <span className="code">Array\<<span className="code">[ObjectTypeIndexer](#objecttypeindexer)</span>\></span> (default: `[]`)
- `callProperties`: <span className="code">Array\<<span className="code">[ObjectTypeCallProperty](#objecttypecallproperty)</span>\></span> (default: `[]`)
- `internalSlots`: <span className="code">Array\<<span className="code">[ObjectTypeInternalSlot](#objecttypeinternalslot)</span>\></span> (default: `[]`)
...
- `value`: <span className="code">[FlowType](#flowtype)</span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (default: `null`)
- `key`: <span className="code">[FlowType](#flowtype)</span> (required)
- `value`: <span className="code">[FlowType](#flowtype)</span> (required)
- `variance`: <span className="code">[Variance](#variance)</span> (default: `null`)
- `static`: boolean (required)
...
- `argument`: <span className="code">[FlowType](#flowtype)</span> (required)
...
- `typeParameters`: <span className="code">[TypeParameterDeclaration](#typeparameterdeclaration)</span> (default: `null`)
- `supertype`: <span className="code">[FlowType](#flowtype)</span> (default: `null`)
- `impltype`: <span className="code">[FlowType](#flowtype)</span> (required)
...
- `object`: <span className="code">[Expression](#expression)</span> (required)
- `property`: <span className="code">[Expression](#expression) | [Identifier](#identifier)</span> (required)
- `computed`: boolean (default: `false`)
- `optional`: boolean (required)
...
- `name`: <span className="code">[Identifier](#identifier)</span> (required)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`, excluded from builder function)
- `optional`: boolean (default: `null`, excluded from builder function)
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
...
- `interpreter`: <span className="code">[InterpreterDirective](#interpreterdirective)</span> (default: `null`)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `qualification`: <span className="code">[Identifier](#identifier) | [QualifiedTypeIdentifier](#qualifiedtypeidentifier)</span> (required)
...
- `properties`: <span className="code">Array\<<span className="code">[ObjectProperty](#objectproperty) | [SpreadElement](#spreadelement)</span>\></span> (required)
...
- `argument`: <span className="code">[Identifier](#identifier) | [ArrayPattern](#arraypattern) | [ObjectPattern](#objectpattern) | [MemberExpression](#memberexpression) | [TSAsExpression](#tsasexpression) | [TSSatisfiesExpression](#tssatisfiesexpression) | [TSTypeAssertion](#tstypeassertion) | [TSNonNullExpression](#tsnonnullexpression) | [RestElement](#restelement) | [AssignmentPattern](#assignmentpattern)</span> (required)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`, excluded from builder function)
- `optional`: boolean (default: `null`, excluded from builder function)
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
...
- `argument`: <span className="code">[Expression](#expression)</span> (default: `null`)
...
- `expressions`: <span className="code">Array\<<span className="code">[Expression](#expression)</span>\></span> (required)
...
- `test`: <span className="code">[Expression](#expression)</span> (default: `null`)
- `consequent`: <span className="code">Array\<<span className="code">[Statement](#statement)</span>\></span> (required)
...
- `discriminant`: <span className="code">[Expression](#expression)</span> (required)
- `cases`: <span className="code">Array\<<span className="code">[SwitchCase](#switchcase)</span>\></span> (required)
...
- `elementType`: <span className="code">[TSType](#tstype)</span> (required)
...
- `expression`: <span className="code">[Expression](#expression)</span> (required)
- `typeAnnotation`: <span className="code">[TSType](#tstype)</span> (required)
...
- `typeParameters`: <span className="code">[TSTypeParameterDeclaration](#tstypeparameterdeclaration)</span> (default: `null`)
- `parameters`: <span className="code">Array\<<span className="code">[ArrayPattern](#arraypattern) | [Identifier](#identifier) | [ObjectPattern](#objectpattern) | [RestElement](#restelement)</span>\></span> (required)
- `typeAnnotation`: <span className="code">[TSTypeAnnotation](#tstypeannotation)</span> (default: `null`)
...
- `checkType`: <span className="code">[TSType](#tstype)</span> (required)
- `extendsType`: <span className="code">[TSType](#tstype)</span> (required)
- `trueType`: <span className="code">[TSType](#tstype)</span> (required)
- `falseType`: <span className="code">[TSType](#tstype)</span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (default: `null`)
- `typeParameters`: <span className="code">[TSTypeParameterDeclaration](#tstypeparameterdeclaration) | [Noop](#noop)</span> (default: `null`)
- `params`: <span className="code">Array\<<span className="code">[FunctionParameter](#functionparameter)</span>\></span> (required)
- `returnType`: <span className="code">[TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`)
- `async`: boolean (default: `false`, excluded from builder function)
- `declare`: boolean (default: `null`, excluded from builder function)
- `generator`: boolean (default: `false`, excluded from builder function)
...
<Code language="javascript">t.tsEnumBody(members);</Code>
*TSEnumBody*
<Code file="/src/codesample/tsEnumBody.js.txt" type="TSEnumBody"/>

See also `t.isTSEnumBody(node, opts)` and `t.assertTSEnumBody(node, opts)`.

AST Node `TSEnumBody` shape:
- `members`: <span className="code">Array\<<span className="code">[TSEnumMember](#tsenummember)</span>\></span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `members`: <span className="code">Array\<<span className="code">[TSEnumMember](#tsenummember)</span>\></span> (required)
- `body`: <span className="code">[TSEnumBody](#tsenumbody)</span> (default: `null`, excluded from builder function)
- `const`: boolean (default: `null`, excluded from builder function)
- `declare`: boolean (default: `null`, excluded from builder function)
- `initializer`: <span className="code">[Expression](#expression)</span> (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[Identifier](#identifier) | [StringLiteral](#stringliteral)</span> (required)
- `initializer`: <span className="code">[Expression](#expression)</span> (default: `null`)
...
- `expression`: <span className="code">[TSEntityName](#tsentityname)</span> (required)
- `typeParameters`: <span className="code">[TSTypeParameterInstantiation](#tstypeparameterinstantiation)</span> (default: `null`)
...
- `expression`: <span className="code">[StringLiteral](#stringliteral)</span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `moduleReference`: <span className="code">[TSEntityName](#tsentityname) | [TSExternalModuleReference](#tsexternalmodulereference)</span> (required)
...
- `argument`: <span className="code">[StringLiteral](#stringliteral)</span> (required)
- `qualifier`: <span className="code">[TSEntityName](#tsentityname)</span> (default: `null`)
- `typeParameters`: <span className="code">[TSTypeParameterInstantiation](#tstypeparameterinstantiation)</span> (default: `null`)
- `options`: <span className="code">[ObjectExpression](#objectexpression)</span> (default: `null`, excluded from builder function)
...
- `parameters`: <span className="code">Array\<<span className="code">[Identifier](#identifier)</span>\></span> (required)
- `typeAnnotation`: <span className="code">[TSTypeAnnotation](#tstypeannotation)</span> (default: `null`)
- `readonly`: boolean (default: `null`, excluded from builder function)
...
- `objectType`: <span className="code">[TSType](#tstype)</span> (required)
- `indexType`: <span className="code">[TSType](#tstype)</span> (required)
...
- `typeParameter`: <span className="code">[TSTypeParameter](#tstypeparameter)</span> (required)
...
- `body`: <span className="code">Array\<<span className="code">[TSTypeElement](#tstypeelement)</span>\></span> (required)
...
- `id`: <span className="code">[Identifier](#identifier)</span> (required)
- `typeParameters`: <span className="code">[TSTypeParameterDeclaration](#tstypeparameterdeclaration)</span> (default: `null`)
- `extends`: <span className="code">Array\<<span className="code">[TSExpressionWithTypeArguments](#tsexpressionwithtypearguments)</span>\></span> (default: `null`)
- `body`: <span className="code">[TSInterfaceBody](#tsinterfacebody)</span> (required)
- `declare`: boolean (default: `null`, excluded from builder function)
...
- `types`: <span className="code">Array\<<span className="code">[TSType](#tstype)</span>\></span> (required)
...
- `literal`: <span className="code">[NumericLiteral](#numericliteral) | [StringLiteral](#stringliteral) | [BooleanLiteral](#booleanliteral) | [BigIntLiteral](#bigintliteral) | [TemplateLiteral](#templateliteral) | [UnaryExpression](#unaryexpression)</span> (required)
...
- `typeParameter`: <span className="code">[TSTypeParameter](#tstypeparameter)</span> (required)
- `typeAnnotation`: <span className="code">[TSType](#tstype)</span> (default: `null`)
- `nameType`: <span className="code">[TSType](#tstype)</span> (default: `null`)
...
- `key`: <span className="code">[Expression](#expression)</span> (required)
- `typeParameters`: <span className="code">[TSTypeParameterDeclaration](#tstypeparameterdeclaration)</span> (default: `null`)
- `parameters`: <span className="code">Array\<<span className="code">[ArrayPattern](#arraypattern) | [Identifier](#identifier) | [ObjectPattern](#objectpattern) | [RestElement](#restelement)</span>\></span> (required)
- `typeAnnotation`: <span className="code">[TSTypeAnnotation](#tstypeannotation)</span> (default: `null`)
- `computed`: boolean (default: `false`, excluded from builder function)
...
- `id`: <span className="code">[Identifier](#identifier) | [StringLiteral](#stringliteral)</span> (required)
- `body`: <span className="code">[TSModuleBlock](#tsmoduleblock) | [TSModuleDeclaration](#tsmoduledeclaration)</span> (required)
- `declare`: boolean (default: `null`, excluded from builder function)
...
- `parameter`: <span className="code">[Identifier](#identifier) | [AssignmentPattern](#assignmentpattern)</span> (required)
- `accessibility`: `"public" | "private" | "protected"` (default: `null`, excluded from builder function)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`, excluded from builder function)
...
<Code language="javascript">t.tsPropertySignature(key, typeAnnotation);</Code>
*TSPropertySignature*
...
- `left`: <span className="code">[TSEntityName](#tsentityname)</span> (required)
- `right`: <span className="code">[Identifier](#identifier)</span> (required)
...
<Code language="javascript">t.tsTemplateLiteralType(quasis, types);</Code>
*TSTemplateLiteralType*
<Code file="/src/codesample/tsTemplateLiteralType.js.txt" type="TSTemplateLiteralType"/>
...
- `quasis`: <span className="code">Array\<<span className="code">[TemplateElement](#templateelement)</span>\></span> (required)
- `types`: <span className="code">Array\<<span className="code">[TSType](#tstype)</span>\></span> (required)
...
- `elementTypes`: <span className="code">Array\<<span className="code">[TSType](#tstype) | [TSNamedTupleMember](#tsnamedtuplemember)</span>\></span> (required)
...
- `members`: <span className="code">Array\<<span className="code">[TSTypeElement](#tstypeelement)</span>\></span> (required)
...
<Code language="javascript">t.tsTypeOperator(typeAnnotation, operator);</Code>
*TSTypeOperator*
...
- `constraint`: <span className="code">[TSType](#tstype)</span> (default: `null`)
- `default`: <span className="code">[TSType](#tstype)</span> (default: `null`)
- `name`: string (required)
- `const`: boolean (default: `null`, excluded from builder function)
...
- `params`: <span className="code">Array\<<span className="code">[TSTypeParameter](#tstypeparameter)</span>\></span> (required)
...
- `params`: <span className="code">Array\<<span className="code">[TSType](#tstype)</span>\></span> (required)
...
- `parameterName`: <span className="code">[Identifier](#identifier) | [TSThisType](#tsthistype)</span> (required)
- `typeAnnotation`: <span className="code">[TSTypeAnnotation](#tstypeannotation)</span> (default: `null`)
...
- `exprName`: <span className="code">[TSEntityName](#tsentityname) | [TSImportType](#tsimporttype)</span> (required)
- `typeParameters`: <span className="code">[TSTypeParameterInstantiation](#tstypeparameterinstantiation)</span> (default: `null`)
...
- `typeName`: <span className="code">[TSEntityName](#tsentityname)</span> (required)
- `typeParameters`: <span className="code">[TSTypeParameterInstantiation](#tstypeparameterinstantiation)</span> (default: `null`)
...
- `tag`: <span className="code">[Expression](#expression)</span> (required)
- `quasi`: <span className="code">[TemplateLiteral](#templateliteral)</span> (required)
- `typeParameters`: <span className="code">[TypeParameterInstantiation](#typeparameterinstantiation) | [TSTypeParameterInstantiation](#tstypeparameterinstantiation)</span> (default: `null`, excluded from builder function)
...
- `quasis`: <span className="code">Array\<<span className="code">[TemplateElement](#templateelement)</span>\></span> (required)
- `expressions`: <span className="code">Array\<<span className="code">[Expression](#expression) | [TSType](#tstype)</span>\></span> (required)
...
- `block`: <span className="code">[BlockStatement](#blockstatement)</span> (required)
- `handler`: <span className="code">[CatchClause](#catchclause)</span> (default: `null`)
- `finalizer`: <span className="code">[BlockStatement](#blockstatement)</span> (default: `null`)
...
- `elements`: <span className="code">Array\<<span className="code">[Expression](#expression) | [SpreadElement](#spreadelement)</span>\></span> (default: `[]`)
...
- `bound`: <span className="code">[TypeAnnotation](#typeannotation)</span> (default: `null`)
- `default`: <span className="code">[FlowType](#flowtype)</span> (default: `null`)
- `variance`: <span className="code">[Variance](#variance)</span> (default: `null`)
- `name`: string (required)
...
- `params`: <span className="code">Array\<<span className="code">[TypeParameter](#typeparameter)</span>\></span> (required)
...
- `params`: <span className="code">Array\<<span className="code">[FlowType](#flowtype)</span>\></span> (required)
...
- `declarations`: <span className="code">Array\<<span className="code">[VariableDeclarator](#variabledeclarator)</span>\></span> (required)
- `declare`: boolean (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[LVal](#lval) | [VoidPattern](#voidpattern)</span> (required)
- `init`: <span className="code">[Expression](#expression)</span> (default: `null`)
- `definite`: boolean (default: `null`, excluded from builder function)
...
<Code language="javascript">t.voidPattern();</Code>
*VoidPattern*
<Code file="/src/codesample/voidPattern.js.txt" type="VoidPattern"/>
...
<Code language="javascript">t.isAccessor(node);</Code>
...
<Code language="javascript">t.isBinary(node);</Code>
...
Deprecated. Will be removed in Babel 8.
<Code language="javascript">t.isBlock(node);</Code>
...
<Code language="javascript">t.isBlockParent(node);</Code>
...
<Code language="javascript">t.isClass(node);</Code>
...
<Code language="javascript">t.isCompletionStatement(node);</Code>
...
<Code language="javascript">t.isConditional(node);</Code>
...
<Code language="javascript">t.isDeclaration(node);</Code>
...
<Code language="javascript">t.isEnumBody(node);</Code>
...
<Code language="javascript">t.isEnumMember(node);</Code>
...
<Code language="javascript">t.isExportDeclaration(node);</Code>
...
<Code language="javascript">t.isExpression(node);</Code>
...
<Code language="javascript">t.isExpressionWrapper(node);</Code>
...
<Code language="javascript">t.isFlow(node);</Code>
...
<Code language="javascript">t.isFlowBaseAnnotation(node);</Code>
...
<Code language="javascript">t.isFlowDeclaration(node);</Code>
...
<Code language="javascript">t.isFlowPredicate(node);</Code>
...
<Code language="javascript">t.isFlowType(node);</Code>
...
<Code language="javascript">t.isFor(node);</Code>
...
<Code language="javascript">t.isForXStatement(node);</Code>
...
<Code language="javascript">t.isFunction(node);</Code>
...
<Code language="javascript">t.isFunctionParameter(node);</Code>
...
<Code language="javascript">t.isFunctionParent(node);</Code>
...
<Code language="javascript">t.isImmutable(node);</Code>
...
<Code language="javascript">t.isImportOrExportDeclaration(node);</Code>
...
<Code language="javascript">t.isJSX(node);</Code>
...
<Code language="javascript">t.isLVal(node);</Code>
...
<Code language="javascript">t.isLiteral(node);</Code>
...
<Code language="javascript">t.isLoop(node);</Code>
...
<Code language="javascript">t.isMethod(node);</Code>
...
<Code language="javascript">t.isMiscellaneous(node);</Code>
...
:::
<Code language="javascript">t.isModuleDeclaration(node);</Code>
...
<Code language="javascript">t.isModuleSpecifier(node);</Code>
...
<Code language="javascript">t.isObjectMember(node);</Code>
...
<Code language="javascript">t.isPattern(node);</Code>
...
<Code language="javascript">t.isPatternLike(node);</Code>
...
<Code language="javascript">t.isPrivate(node);</Code>
...
<Code language="javascript">t.isProperty(node);</Code>
...
<Code language="javascript">t.isPureish(node);</Code>
...
<Code language="javascript">t.isScopable(node);</Code>
...
<Code language="javascript">t.isStandardized(node);</Code>
...
<Code language="javascript">t.isStatement(node);</Code>
...
<Code language="javascript">t.isTSBaseType(node);</Code>
...
<Code language="javascript">t.isTSEntityName(node);</Code>
...
<Code language="javascript">t.isTSType(node);</Code>
...
<Code language="javascript">t.isTSTypeElement(node);</Code>
...
<Code language="javascript">t.isTerminatorless(node);</Code>
...
<Code language="javascript">t.isTypeScript(node);</Code>
...
<Code language="javascript">t.isUnaryLike(node);</Code>
...
Deprecated. Will be removed in Babel 8.
<Code language="javascript">t.isUserWhitespacable(node);</Code>
...
<Code language="javascript">t.isWhile(node);</Code>
