...
- `elements`: <span className="code">Array\<null | [PatternLike](#patternlike) | [LVal](#lval)\></span> (required)
...
- `params`: <span className="code">Array\<<span className="code">[Identifier](#identifier) | [Pattern](#pattern) | [RestElement](#restelement)</span>\></span> (required)
...
- `arguments`: <span className="code">Array\<<span className="code">[Expression](#expression) | [SpreadElement](#spreadelement) | [JSXNamespacedName](#jsxnamespacedname) | [ArgumentPlaceholder](#argumentplaceholder)</span>\></span> (required)
...
- `params`: <span className="code">Array\<<span className="code">[Identifier](#identifier) | [Pattern](#pattern) | [RestElement](#restelement) | [TSParameterProperty](#tsparameterproperty)</span>\></span> (required)
- `body`: <span className="code">[BlockStatement](#blockstatement)</span> (required)
- `computed`: boolean (default: `false`)
- `static`: boolean (default: `false`)
...
- `attributes`: <span className="code">Array\<<span className="code">[ImportAttribute](#importattribute)</span>\></span> (default: `null`, excluded from builder function)
- `exportKind`: `"type" | "value"` (default: `null`, excluded from builder function)
...
- `argument`: <span className="code">[LVal](#lval)</span> (required)
- `decorators`: <span className="code">Array\<<span className="code">[Decorator](#decorator)</span>\></span> (default: `null`, excluded from builder function)
- `optional`: boolean (default: `null`, excluded from builder function)
- `typeAnnotation`: <span className="code">[TypeAnnotation](#typeannotation) | [TSTypeAnnotation](#tstypeannotation) | [Noop](#noop)</span> (default: `null`, excluded from builder function)
...
- `id`: <span className="code">[LVal](#lval)</span> (required)
